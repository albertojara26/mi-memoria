...
Para el caso que el usuario ya esté autenticado dividiremos en 3 grupos los casos de usos:
\begin{itemize}
...
\item \textbf{\textit{R-G-4 Ver grupos}}, el sistema lista los grupos en los que el usuario está registrado.
...
\begin{itemize}
\item \textbf{\textit{R-R-1.1}} Iniciar ruta, el sistema comienza a guardar las coordenadas por la que el usuario está navegando y dibujando la ruta en el mapa. Las coordenadas se irán guardando periódicamente, no solo al finalizar la ruta y visualizarla.
...
\begin{itemize}
\item \textbf{\textit{R-R-2.1 Iniciar ruta}}, se comienza a guardar y dibujar la ruta en el mapa. Por otra parte se comienza el seguimiento del resto de usuarios que estén también navegando, como también una actualización parcial de la ruta seguida en el servidor.
...
de comenzar el diseño o la implementación, y que así   vigilarlos. En el caso de este proyecto la manera de solventarlos fue diferente.  A continuación se comentan.
...
\subsection{Seguimiento} 	
	Para el resto de riesgos se hará un seguimiento.
	\begin{itemize}
...
En la figura \ref{fig:verg} vemos como se mostrarían los grupos a los que pertenece el usuario y a continuación vemos la maqueta de como serían las opciones que tiene el usuario para interactuar con la aplicación \ref{fig:opc}.
...
\end{figure}
 ...
 A continuación mostraríamos como se crearía un PDI \ref{fig:pdi1} y como lo veríamos una vez creado \ref{fig:pdi2}.	
